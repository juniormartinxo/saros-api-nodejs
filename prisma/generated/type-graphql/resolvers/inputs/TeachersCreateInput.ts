...
import { SchoolsCreateNestedOneWithoutTeachersInput } from "../inputs/SchoolsCreateNestedOneWithoutTeachersInput";

@TypeGraphQL.InputType("TeachersCreateInput", {
  isAbstract: true
})
export class TeachersCreateInput {
  ...
  @TypeGraphQL.Field(_type => SchoolsCreateNestedOneWithoutTeachersInput, {
    nullable: false
  })
